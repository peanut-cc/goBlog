...
func (*User) scanValues() []interface{} {
	return []interface{}{
		...
		&sql.NullTime{},   // login_time
		&sql.NullTime{},   // logout_time
	}
}
...
func (u *User) assignValues(values ...interface{}) error {
	...
	if value, ok := values[5].(*sql.NullTime); !ok {
		return fmt.Errorf("unexpected type %T for field login_time", values[5])
	} else if value.Valid {
		u.LoginTime = value.Time
	}
	if value, ok := values[6].(*sql.NullTime); !ok {
		return fmt.Errorf("unexpected type %T for field logout_time", values[6])
	} else if value.Valid {
...
func (u *User) String() string {
	...
	builder.WriteString(u.LogoutTime.Format(time.ANSIC))
	builder.WriteByte(')')
